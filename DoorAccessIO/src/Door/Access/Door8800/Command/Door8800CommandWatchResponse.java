 ...
 * @author 赖金杰
 */
public class Door8800CommandWatchResponse extends AbstractWatchResponse {

    public Door8800CommandWatchResponse() {
            ...
            if (packet.GetCmdType() == 0x19) {
                ...
                switch (watchevent.CmdIndex) {
                    case 1://读卡信息
                        ...
                        //Door89H
                        if (buf.capacity()  == 17) {
                            Door.Access.Door89H.Command.Data.CardTransaction card = new Door.Access.Door89H.Command.Data.CardTransaction();
                            card.SetBytes(buf);
