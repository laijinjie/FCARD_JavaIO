 ...
 * @author 赖金杰
 */
public class Door8800PacketCompile implements INPacket {

    private Door8800PacketModel _Packet = null;
     ...
     * @param iCmdPar
     */
    public Door8800PacketCompile(String sn, long pwd, short iCmdType, short iCmdIndex, short iCmdPar) {
     ...
     * @param Databuf
     */
    public Door8800PacketCompile(String sn, long pwd, short iCmdType, short iCmdIndex, short iCmdPar, int iDataLen, ByteBuf Databuf) {
        long lSource = UInt32Util.GetRndNum();//获取一个随机数
     ...
     * @param Databuf
     */
    public Door8800PacketCompile(String sn, long pwd, long code, short iCmdType, short iCmdIndex, short iCmdPar, int iDataLen, ByteBuf Databuf) {
    ...
    private void CreateFrame(String sn, long pwd, long code, short iCmdType, short iCmdIndex, short iCmdPar, int iDataLen, ByteBuf Databuf) {
        ...
        _Packet = new Door8800PacketModel();
        _Packet.SetSN(sn);
    ...
    public void SetPacket(INPacketModel packet) {
        ...
        _Packet = (Door8800PacketModel) packet;
        if (_Packet == null) {
            Release();
        }
        Compile();
