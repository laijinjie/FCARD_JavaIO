...
public class TCPClientConnector extends AbstractConnector {
            ...
            case OnConnected:
                ...
                if (_ActivityCommand != null) {
                    ...
                    switch (_ActivityCommand.GetStatus()) {
                        case OnReady:
                            //System.out.println("Net.PC15.Connector.TCPClient.TCPClientConnector.CheckStatus() -- 准备发送指令");
                            //发送数据
    ...
    private void ConnectServer() {
        ...
        //System.out.println("Net.PC15.Connector.TCPClient.TCPClientConnector.ConnectServer() -- 准备连接服务器：" + _RemoteDetail.IP + ":" + _RemoteDetail.Port);
        ...
        public void operationComplete(ChannelFuture future) throws Exception {
            ...
            if (future.isDone()) {
                if (future.isCancelled()) {
                    //System.out.println("Net.PC15.Connector.TCPClient.TCPClientConnector.connectCallback.operationComplete() -- 服务器连接已取消");
                    _tcpClient.ConnectFail();
                    _tcpClient._Status = E_ConnectorStatus.OnClosed;
                } else if (future.isSuccess()) {
                    //System.out.println("Net.PC15.Connector.TCPClient.TCPClientConnector.connectCallback.operationComplete() -- 服务器连接完毕");
                    _tcpClient._Handler = new TCPClientNettyHandler(_tcpClient);
                    future.channel().pipeline().addLast(_tcpClient._Handler);//命令处理
                    ConnectSuccess();
                } else {
                    //System.out.println("Net.PC15.Connector.TCPClient.TCPClientConnector.connectCallback.operationComplete() -- 服务器连接失败");
                    _tcpClient.ConnectFail();
                }
    ...
    private void ConnectFail() {
        ...
        if (_ConnectFailCount >= _ReconnectMax) {
            try {
                ...
                //System.out.println("Net.PC15.Connector.TCPClient.TCPClientConnector.ConnectFail()" + e.toString());
            }
    ...
    private void ConnectSuccess() {
        //System.out.println("Net.PC15.Connector.TCPClient.TCPClientConnector.ConnectSuccess() -- 连接成功");
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        ...
        //System.out.println("Net.PC15.Connector.TCPClient.TCPClientConnector.channelInactive() -- 连接通道被关闭");
