    ...
    public boolean CheckTimeout(INConnectorEvent oEvent) {
        ...
        if (bIsTimeout) {
            ...
            if (_ReSendCount != iMaxReSendCount) {
                //System.out.println("Net.PC15.Command.AbstractCommand.CheckTimeout() -- 命令等待超时，准备重发命令！");
                CommandOver_ReSend();
                ...
                //System.out.println("Net.PC15.Command.AbstractCommand.CheckTimeout() -- 命令已超时！");
                _IsTimeout = true;
                CommandOver();
...
//        INCommand cmd,INCommandResult result
        //System.out.println("Net.PC15.Command.AbstractCommand.RaiseCommandCompleteEvent() -- 发送命令完成事件");
        CommandOver();
        if (oEvent != null) {
    ...
    public void RaiseCommandProcessEvent(INConnectorEvent oEvent) {
        //INCommand cmd
        //System.out.println("Net.PC15.Command.AbstractCommand.RaiseCommandProcessEvent() -- 发送命令进度事件");
        if (oEvent != null) {
