...
import Net.PC15.FC89H.Command.Card.WriteCardListBySequence;
import Net.PC15.FC89H.Command.Card.WriteCardListBySort;
...
public class UploadCard  implements INConnectorEvent{
    ...
    public void UploadCardList(){
        ...
        commandDetial.Identity = new FC8800Identity("MC-5824T25070244","FFFFFFFF",E_ControllerType.FC8900);//设置SN(16位字符)，密码(8位十六进制字符)，设备类型
        //创建卡片列表对象
    ...
    public void UploadSortCardList(){
        ...
        //commandDetial.Timeout = 10000;
            commandDetial.Identity = new FC8800Identity("FC-8940H47124309", "FFFFFFFF", E_ControllerType.FC8900);//设置SN(16位字符)，密码(8位十六进制字符)，设备类型
        ArrayList<CardDetail> mCardList = new ArrayList<>();
        //创建卡片信息
